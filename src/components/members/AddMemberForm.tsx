...
const AddMemberForm: FC<AddMemberFormProps> = ({ onSuccess, onCancel }) => {
  ...
  const onSubmit = async (data: MemberFormValues) => {
    ...
    try {
      // Type the formattedData to match what's expected by Supabase
      // We omit unique_id since it will be generated by the trigger
      type MemberInsertData = Omit<Database['public']['Tables']['members']['Insert'], 'unique_id'>;
      
      const formattedData: MemberInsertData = {
        name: data.name,
        age: data.age,
      ...
      // The unique_id is automatically generated by the trigger function on the database
      // We cast the insert to ignore TypeScript's requirement for unique_id
